    ...
    <div className="relative h-dhv w-screen overflow-x-hidden">
        <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden
         rounded-lg bg-blue-75">
            <div>
                <div className="mask-clip-path absolute-center absolute z-50
                 size-64 cursor-pointer overflow-hidden rounded-lg">
                    <div onClick={handleMiniVidClick} className="origin-center scale-50 opacity-0
                    transition-all duration-500 ease-in hover:scale-100 hover:opacity-100">
                        <video loop muted id='current-video' className="size-64 origin-center scale-150
            ...
            <h1 className="special-font hero-heading absolute bottom-5  text-blue-100 right-5 z-40 text-blue-75">

                G<b>a</b>ming

            </h1>
            <div className=" special-font absolute left-0 top-0 z-40 size-full ">
         ...
         <h1 className="special-font hero-heading absolute bottom-5  text-blue-100 right-5  text-black">
G<b>a</b>ming
